...
class CFirstStepsCtrl : public ITcOCFCtrlImpl<CFirstStepsCtrl, CFirstStepsClassFactory>
{
public:
	CFirstStepsCtrl() {};
	virtual ~CFirstStepsCtrl() {};
};
...
{
	HRESULT hr = E_FAIL;
	TRACE("FirstSteps: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CFirstStepsCtrl>;
